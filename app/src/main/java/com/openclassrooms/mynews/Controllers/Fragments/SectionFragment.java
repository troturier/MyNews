...
public class SectionFragment extends Fragment implements ArticleAdapter.Listener {

    // FOR DESIGN
    @BindView(R.id.fragment_section_recycler_view)
    RecyclerView recyclerView;
    @BindView(R.id.fragment_section_swipe_container)
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            section = bundle.getString("section", "home");
        }
    ...
    public void executeHttpRequestWithRetrofit(){
        ...
        this.disposable = NyTimesStreams.streamFetchTopStories(section.toLowerCase()).subscribeWith(new DisposableObserver<Articles>() {
            @Override
            public void onNext(Articles articles) {
                updateUI(articles.getArticles());
            }
