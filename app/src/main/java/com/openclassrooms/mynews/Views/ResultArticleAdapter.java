 ...
 */
public class ResultArticleAdapter extends RecyclerView.Adapter<ResultArticleViewHolder> {
    ...
    // CONSTRUCTOR
    public ResultArticleAdapter(Articles articles, RequestManager glide, Listener callback) {
    ...
    @NonNull
    @Override
    public ResultArticleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.fragment_search_item, parent, false);

        return new ResultArticleViewHolder(view);
    }
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull ResultArticleViewHolder viewHolder, int position) {
